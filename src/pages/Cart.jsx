      ...
      <div className="new-body js-cart-body" id="main">
        ...
        <aside className="cart-checkout">
          <div className="checkout-sticky">
            ...
            <button style={{width: '100%', padding: '15px', backgroundColor: '#ee0652', color: 'white', border: 'none', borderRadius: '5px', fontWeight: 'bold', fontSize: '16px', cursor: 'pointer', marginTop: '20px'}}>Checkout</button>
          </div>
        </aside>
      </div>
    </div>
